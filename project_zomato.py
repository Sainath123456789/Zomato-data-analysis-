...
df_data = pd.read_csv(r"C:\Users\Sainath\Downloads\zomato.csv", encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r"C:\Users\Sainath\Downloads\Country-Code.xlsx")
print(df_country)
...
# downlaod data
# df.to_csv(r"C:\Users\Sainath\Downloads\zomato.csv")
print(df.to_string)